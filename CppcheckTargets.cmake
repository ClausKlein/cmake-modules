...
function(add_cppcheck_sources _targetname)
  if(CPPCHECK_FOUND)
    ...
    if("1.${CMAKE_VERSION}" VERSION_LESS "1.2.8.0")
      ...
      add_test(NAME ${_targetname}_cppcheck_test COMMAND "${CPPCHECK_EXECUTABLE}" ${CPPCHECK_TEMPLATE_ARG}
                                                         ${_cppcheck_args} ${_files}
      )
    endif()

    set_tests_properties(
      ${_targetname}_cppcheck_test PROPERTIES FAIL_REGULAR_EXPRESSION "${CPPCHECK_FAIL_REGULAR_EXPRESSION}"
    )
...
function(add_cppcheck _name)
  ...
  if(CPPCHECK_FOUND)
    ...
    if("1.${CMAKE_VERSION}" VERSION_LESS "1.2.8.0")
      ...
      # CMake 2.8.0 and newer
      add_test(NAME ${_name}_cppcheck_test COMMAND "${CPPCHECK_EXECUTABLE}" ${CPPCHECK_TEMPLATE_ARG} ${_cppcheck_args}
                                                   ${_files}
      )
    endif()

    set_tests_properties(${_name}_cppcheck_test PROPERTIES FAIL_REGULAR_EXPRESSION "${CPPCHECK_FAIL_REGULAR_EXPRESSION}")
