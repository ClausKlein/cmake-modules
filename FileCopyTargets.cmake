...
define_property(
  TARGET PROPERTY FILE_COPY_TARGET BRIEF_DOCS "File Copy target"
  FULL_DOCS "Is this a target created by add_file_copy_target?"
)

function(add_file_copy_target _target _dest)
  if(NOT ARGN)
    message(WARNING "In add_file_copy_target call for target ${_target}, no source files were specified!")
    return()
  endif()
  ...
  foreach(fn ${ARGN})
    ...
    add_custom_command(
      OUTPUT "${absout}"
      COMMAND ${CMAKE_COMMAND} ARGS -E make_directory "${_dest}"
      COMMAND ${CMAKE_COMMAND} ARGS -E copy "${fullpath}" "${_dest}"
  ...
  add_custom_target(${_target} SOURCES ${SOURCES} DEPENDS ${ALLFILES})
...
function(install_file_copy_target _target)
  ...
  if(NOT _isFCT)
    message(WARNING "install_file_copy_target called on a target not created with add_file_copy_target!")
    return()
  endif()
