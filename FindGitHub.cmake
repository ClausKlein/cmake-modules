...
if(WIN32 AND NOT GITHUB_FOUND)
  ...
  # Check install Path
  find_path(GITHUB_DIR shell.ps1 PATHS $ENV{LOCALAPPDATA}/GitHub $ENV{GitHub_DIR} NO_DEFAULT_PATH)

  if(GITHUB_DIR)

    execute_process(COMMAND cmd /c "cd ${GITHUB_DIR}/PortableGit*/bin & cd" OUTPUT_VARIABLE PORTABLE_GIT_WIN_DIR)
