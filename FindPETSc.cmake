...
find_library(
  PETSC_BLAS_LIBRARY NAMES blas f2cblas PATHS ${PETSC_ROOT} ${PETSC_DIR}
  PATH_SUFFIXES lib lib${_BITS} lib/${CMAKE_LIBRARY_ARCHITECTURE} ${_no_default_path}
)
...
find_library(
  PETSC_LAPACK_LIBRARY NAMES lapack f2clapack PATHS ${PETSC_ROOT} ${PETSC_DIR}
  PATH_SUFFIXES lib lib${_BITS} lib/${CMAKE_LIBRARY_ARCHITECTURE} ${_no_default_path}
)
...
if(MPI_FOUND)
  ...
  find_path(PETSC_MPI_INCLUDE_DIRS NAMES "mpi.h" PATHS ${PETSC_ROOT}/include PATH_SUFFIXES "mpiuni" ${_no_default_path})
endif(MPI_FOUND)
...
#if(NOT PETSC_FOUND)
find_path(PETSC_NORMAL_INCLUDE_DIR NAMES "petsc.h" PATHS ${PETSC_ROOT} PATH_SUFFIXES "include" "petsc" ${_no_default_path})

list(APPEND PETSC_INCLUDE_DIR ${PETSC_NORMAL_INCLUDE_DIR})

# look for actual Petsc library
find_library(
  PETSC_LIBRARY NAMES "petsc-3.4.3" "petsc-3.4.4" "petsc" PATHS ${PETSC_ROOT}
  PATH_SUFFIXES "lib" "lib${_BITS}" "lib/${CMAKE_LIBRARY_ARCHITECTURE}" ${_no_default_path}
)
#endif()
