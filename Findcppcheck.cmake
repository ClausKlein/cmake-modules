...
function(_cppcheck_test_arg _resultvar _arg)
  ...
  execute_process(
    COMMAND "${CPPCHECK_EXECUTABLE}" "${_arg}" "--quiet" "${_cppcheckdummyfile}" RESULT_VARIABLE _cppcheck_result
...
if(CPPCHECK_EXECUTABLE)
  ...
  elseif("${CPPCHECK_STYLE_ARG}" STREQUAL "--style")
    ...
    message(STATUS "WARNING: Can't detect whether CPPCHECK wants new or old-style arguments!")
  endif()
