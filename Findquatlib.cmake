...
if(TARGET quat)
  ...
  find_path(QUATLIB_INCLUDE_DIR NAMES quat.h PATHS ${quatlib_SOURCE_DIR})

  set(QUATLIB_LIBRARY "quat")

else()
  set(QUATLIB_ROOT_DIR "${QUATLIB_ROOT_DIR}" CACHE PATH "Root directory to search for quatlib")
  ...
  find_path(
    QUATLIB_INCLUDE_DIR
    NAMES quat.h
    HINTS "${QUATLIB_ROOT_DIR}"
    PATH_SUFFIXES include
    PATHS "${_progfiles}/VRPN" "${_progfiles}/quatlib"
  )

  # Look for the library.
  find_library(
    QUATLIB_LIBRARY
    NAMES quat.lib libquat.a
    HINTS "${QUATLIB_ROOT_DIR}"
