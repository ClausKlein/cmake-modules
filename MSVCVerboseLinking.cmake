...
if(MSVC)
  ...
  set(MSVC_LINK_REALLY_VERBOSE "${MSVC_LINK_REALLY_VERBOSE}" CACHE BOOL "Provide maximum linker messages?")
  ...
  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${_verbose_flag}")
  set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} ${_verbose_flag}")
  set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${_verbose_flag}")
endif()
