...
option(ENABLE_CLANG_TIDY "Add clang-tidy checks automatically as prebuild step" YES)

find_program(CLANG_TIDY_EXE NAMES clang-tidy clang-tidy-7 DOC "Path to clang-tidy executable")
find_program(
  CLANG_TIDY_RUNNER NAMES run-clang-tidy run-clang-tidy-7 run-clang-tidy.py HINTS ${CMAKE_CURRENT_SOURCE_DIR}/scripts
)
if(CLANG_TIDY_EXE)
  ...
  if(ENABLE_CLANG_TIDY)
    # NOTE: the project config file .clang-tidy is not found if the binary tree is not part of
    # the source tree!
